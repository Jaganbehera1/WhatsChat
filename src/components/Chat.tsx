    ...
    try {
      ...
      channel.on(
        ...
        (payload) => {
          ...
          setMessages(prev => {
            // IMPORTANT FIX: Check if message is from current user to prevent duplicates
            ...
            // Add to the end (assuming messages are sorted by time)
            console.log('✅ Adding new message from other user via real-time');
